...
const program = new Command('secret')
  ...
  .addHelpText('after', '  secret encrypt -t text')
  .addHelpText('after', '  secret decrypt -t text')
  .addHelpText('after', ' ')
  .addHelpText('after', 'Usage examples(file):')
  .addHelpText('after', '  secret encrypt -f file.txt')
  .addHelpText('after', '  secret decrypt -f file.txt')
  .addHelpText('after', '  secret encrypt -k key -f file.txt -o file_enc.txt -b')
  .addHelpText('after', ' ')
  .addHelpText('after', 'Usage examples(dir):')
  .addHelpText('after', '  secret encrypt -d dir')
  .addHelpText('after', '  secret decrypt -d dir')
